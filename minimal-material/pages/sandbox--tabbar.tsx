              ...
              <div className="mdc-tab-scroller__scroll-content">
                ...
                >
                  ...
                  <span
                    ...
                    style={
                      {
                        "--mdc-ripple-fg-size": "184px",
                        "--mdc-ripple-fg-scale": "1.74553",
                        "--mdc-ripple-fg-translate-start":
                          "82.9063px, -79.7813px",
                        "--mdc-ripple-fg-translate-end": "61.7266px, -68px",
                      } as CSSProperties
                    }
                  ></span>
                </button>
                ...
                >
                  ...
                  <span
                    ...
                    style={
                      {
                        "--mdc-ripple-fg-size": "197px",
                        "--mdc-ripple-fg-scale": "1.74077",
                        "--mdc-ripple-fg-translate-start":
                          "51.9531px, -69.2813px",
                        "--mdc-ripple-fg-translate-end": "66.2266px, -74.5px",
                      } as CSSProperties
                    }
                  ></span>
                </button>
                ...
                >
                  ...
                  <span
                    ...
                    style={
                      {
                        "--mdc-ripple-fg-size": "189px",
                        "--mdc-ripple-fg-scale": "1.7682",
                        "--mdc-ripple-fg-translate-start": "88.5px, -82.2813px",
                        "--mdc-ripple-fg-translate-end": "63.5469px, -58.5px",
                      } as CSSProperties
                    }
                  ></span>
                </button>
                ...
                >
                  ...
                  <span
                    ...
                    style={
                      {
                        "--mdc-ripple-fg-size": "184px",
                        "--mdc-ripple-fg-scale": "1.7705",
                        "--mdc-ripple-fg-translate-start":
                          "25.9063px, -82.7813px",
                        "--mdc-ripple-fg-translate-end": "61.7266px, -56px",
                      } as CSSProperties
                    }
                  ></span>
                </button>
              ...
              >
                ...
                >
                  ...
                  <span
                    ...
                    style={
                      {
                        "--mdc-ripple-fg-size": "76px",
                        "--mdc-ripple-fg-scale": "1.93301",
                        "--mdc-ripple-fg-translate-start":
                          "14.4063px, 0.21875px",
                        "--mdc-ripple-fg-translate-end": "26.1094px, -14px",
                      } as CSSProperties
                    }
                  ></span>
                </button>
      ...
      <section>
        <div>
          <div>
            ...
            <div
              tabIndex={-1}
              className={`${base} _hover content_nearby`}
            ></div>
            <div
              tabIndex={-1}
              className={`${base} _active _bordered content_favorites`}
            ></div>
            <div
              tabIndex={-1}
              className={`${base} _active content_favorites`}
            ></div>
          </div>
        </div>
        <div>
          <div>
            <div
              tabIndex={-1}
              className={`${base}_small content_recents`}
            ></div>
            <div
              tabIndex={-1}
              className={`${base}_small _hover content_nearby`}
            ></div>
            <div
              tabIndex={-1}
              className={`${base}_small _active _bordered content_favorites`}
            ></div>
            <div
              tabIndex={-1}
              className={`${base}_small _active content_favorites`}
            ></div>
          </div>
        </div>
        <div>
          <div>
            <div
              tabIndex={-1}
              className={`${base} _active content_tab_One`}
            ></div>
            <div
              tabIndex={-1}
              className={`${base} _focus content_tab_Two`}
            ></div>
            ...
            <div
              tabIndex={-1}
              className={`${base} _active _bordered content_tab_Eight`}
            ></div>
